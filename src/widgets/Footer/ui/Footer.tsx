...
const navigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/fp.if.ua',
  ...
  return (
    <footer className="mx-auto w-full space-y-4 overflow-hidden border-t p-2">
      <div className="flex items-center justify-between pt-5">
        ...
        <section className="flex gap-20 whitespace-nowrap">
          <section className="space-y-3 text-sm leading-6">
            <div className="flex items-center gap-x-4 text-gray-600">
              ...
              <dd>
                <p className="hover:text-gray-900">
                  м. Івано-Франківськ, Тролейбусна 10
                </p>
              </dd>
            </div>
            ...
            <div className="flex items-center gap-x-4 text-gray-600">
              ...
              <dd>
                <p className="hover:text-gray-900">о. Михайло Добровольський</p>
              </dd>
            </div>
          </section>
          ...
          <section className="space-y-3">
            ...
            <a
              className="flex items-center gap-2 text-sm leading-6 text-slate-700 transition hover:text-gray-900"
              href="mailto:palomnyk.if@gmail.com"
            >
              <EnvelopeIcon className="h-5 w-5" aria-hidden="true" />
              <span>palomnyk.if@gmail.com</span>
            </a>
          </section>
        </section>
      </div>
